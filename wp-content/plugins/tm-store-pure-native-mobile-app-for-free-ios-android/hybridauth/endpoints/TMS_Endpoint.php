...
class TMS_Hybrid_Endpoint extends Hybrid_Endpoint
{
	public static function process( $request = NULL )
	{
		...
		if ( isset( TMS_Hybrid_Endpoint::$request["hauth_start"] ) && TMS_Hybrid_Endpoint::$request["hauth_start"] ) {
			return TMS_Hybrid_Endpoint::processAuthStart();
		}

		// Else if hauth.done
		elseif ( isset( TMS_Hybrid_Endpoint::$request["hauth_done"] ) && TMS_Hybrid_Endpoint::$request["hauth_done"] ) {
			return TMS_Hybrid_Endpoint::processAuthDone();
		}
	...
	{
		TMS_Hybrid_Endpoint::authInit();

		try {
			parent::processAuthStart();
		}
		catch( Exception $e ){
			TMS_Hybrid_Endpoint::dieError( "412 Precondition Failed", $e->getMessage() . "<br />For more information refer to TMS <a href='troubleshooting.html' target='_blank'>Troubleshooting</a>" );
		}
	}
	...
	public static function processAuthDone()
	{
		...
		try {
			...
			TMS_Hybrid_Endpoint::dieError( "410 Gone", $e->getMessage() . "<br />For more information refer to TMS <a href='troubleshooting.html' target='_blank'>Troubleshooting</a>" );
		}
	}
	...
	public static function authInit()
	{
		...
		if ( ! TMS_Hybrid_Endpoint::$initDone ){
			...
			try{
				...
				TMS_Hybrid_Endpoint::dieError( '500 Internal Server Error', 'An error occurred while attempting to initialize Hybridauth' );
			}
		}
	}
	...
	public static function dieError( $code, $message )
	{
		...
		display_tms_error( $code, $message );
...
*/
function display_tms_error( $code, $message )
{
