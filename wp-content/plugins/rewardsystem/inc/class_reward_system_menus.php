...
class FPRewardSystemMenus {
    ...
    public static function reward_system_as_a_submenu_of_woocommerce() {
        ...
        $my_admin_page = add_submenu_page('woocommerce', 'Sumo Reward Points', 'Sumo Reward Points', 'manage_woocommerce', 'rewardsystem_callback', array('FPRewardSystemMenus', 'reward_system_admin_tab_settings'));
    }
