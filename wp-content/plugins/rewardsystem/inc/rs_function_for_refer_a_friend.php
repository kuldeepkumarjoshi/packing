            ...
            <form id="rs_refer_a_friend_form" method="post">
                <table class="shop_table my_account_referrals">
                    ...
                    <tr>
                        ...
                        $friend_free_product_replaced = str_replace($friend_free_product_to_find, $friend_free_product_to_replace, get_option('rs_friend_referral_link'));
                        $referurl = $friend_free_product_replaced;
                        ?>
                        <td><textarea rows="5" cols="35" id="rs_your_message" placeholder ="<?php echo get_option('rs_my_rewards_friend_email_message_placeholder'); ?>" name="rs_your_message"><?php echo $referurl; ?></textarea>
                            <br>
                            <div class="rs_notification"></div>
                        </td>
                    </tr>
                ...
                <tr>
                               ...
                               <?php 
                               $initialmessage = get_option('rs_refer_friend_iagreecaption_link');
                               $stringtofind = "{termsandconditions}";
                               $hyperlinkforterms = get_option('rs_refer_friend_termscondition_url');
                               $stringtoreplace ="<a href='$hyperlinkforterms'>". get_option('rs_refer_friend_termscondition_caption')."</a>";
			...
			//Do what ever with the email.
                    ...
                    jQuery('#rs_friend_email').css('border', '2px solid red');
                        ...
                        if (terms == 'no') {
                            ...
                            //jQuery('#rs_terms').parent().find('.rs_notification').html('<?php echo "Please Accept our Terms And Conditions"; ?> ');
                            return false;
                        } 
                        <?php } ?>
        ...
        if (isset($_POST)) {
            ...
            if (get_option('rs_select_mail_function') == '1') {
                ...
                if ((float) $woocommerce->version <= (float) ('2.2.0')) {
                    ...
                    $mailer = WC()->mailer();
                    $mailer->send($value, $friendsubject, $woo_rs_msg, '', '');
                }
            }
