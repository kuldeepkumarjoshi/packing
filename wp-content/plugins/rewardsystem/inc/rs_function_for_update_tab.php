                        ...
                        if ($checkproducts->is_type('simple') || ($checkproducts->is_type('subscription'))) {
                            ...
                            if (is_array($term)) {
                                foreach ($allcategories as $mycategory) {
                                    ...
                                    RSFunctionForSavingMetaValues::rewardsystem_update_post_meta($product, '_rewardsystem__points', '');
                                ...
                                foreach ($checkproducts->get_available_variations() as $getvariation) {
                                    ...
                                    if (is_array($term)) {
                                        foreach ($allcategories as $mycategory) {
                                            ...
                                            RSFunctionForSavingMetaValues::rewardsystem_update_post_meta($getvariation['variation_id'], 'price_points', '');
