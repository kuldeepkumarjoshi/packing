...
class RSVariableProduct {
    ...
    public function __construct() {
        ...
        add_action('woocommerce_variation_options', array($this, 'rs_validation_for_input_field_in_variable_product'));
    ...
    public static function add_shortcode_for_rewardpoints_of_variation_point($variation_id) {
        ...
        if ($point_price_type == 1) {
            ...
            $updatedvalue = $newvalue * get_option('rs_redeem_point');
            $rewardpoints = $updatedvalue;
            RSFunctionForSavingMetaValues::rewardsystem_update_post_meta($variation_id, '_price_points_based_on_conversion', $rewardpoints);
            return $rewardpoints;
        }
    }
            ...
            if ($checkenable == '1') {
                if ($checkrule == '1') {
                    ...
                    if (get_option('rs_set_price_to_calculate_rewardpoints_by_percentage') == '1') {
                        ...
                        $variationregularprice = $variable_product1->sale_price;
