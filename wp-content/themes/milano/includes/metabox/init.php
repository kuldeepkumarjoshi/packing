...
class cmb_Meta_Box {
	...
	public static function autoload_helpers( $class_name ) {
		...
		$dir = get_template_directory() . '/includes/metabox';
	...
	public static function get_meta_box_url() {
		...
		if ( strtoupper( substr( PHP_OS, 0, 3 ) ) === 'WIN' ) {
			...
			$content_url = str_replace( $content_dir, WP_CONTENT_URL, get_template_directory() . '/includes/metabox' );
		  ...
		  $cmb_url = str_replace(
				...
				get_template_directory() . '/includes/metabox'
				//dirname( __FILE__ )
			);
		}
