...
require get_template_directory() . '/includes/importer/data_import/parsers.php';
...
<?php endif; ?>
	...
	<p class="submit"><input type="submit" class="button" value="<?php _e( 'Submit', 'wordpress-importer' ); ?>" /></p>
</form>
<?php
	}
