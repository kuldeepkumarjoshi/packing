	...
	<div class="large-6 columns">
		...
		<?php if ( WC()->cart->coupons_enabled() ) { ?>
			<div class="coupon">
				...
				<input type="text" name="coupon_code"  id="coupon_code" value="" placeholder="<?php _e( 'Enter Coupon', 'ltheme_domain' ); ?>"/> 
				<input type="submit" class="button small" name="apply_coupon" value="<?php _e( 'Apply Coupon', 'woocommerce' ); ?>" />
